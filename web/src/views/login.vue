  ...
  <div v-if="!isLoggedIn" class="flex justify-center items-center h-screen">
    <div class="bg-colorBackground p-6 rounded shadow-md shadow-black justify-center flex flex-col ">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <button type="submit" class="bg-colorAccent hover:bg-blue-500 hover:text-black duration-300 text-white font-bold w-full py-2 px-4 rounded focus:outline-none focus:shadow-outline flex flex-row justify-end">
          Login
